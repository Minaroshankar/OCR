        ...
        for sheet_name in xls.sheet_names:
            ...
            for idx, row in df.iterrows():
                ...
                if os.path.exists(full_path):
                    ...
                    print(f"⚠️ No path found: {full_path}")
...
def main():
    """
    Main workflow:
    1. Rename image files in directories.
    2. Process Excel and save image labels to text file.
    """
    # path
    rename_base_path = r"C:\Users\Mina\Desktop\New folder (3)"
    excel_file_path = r"C:\Users\Mina\Desktop\excel khayamm.xlsx"
    khayamm_base_path = r"C:\Users\Mina\Desktop\work\ocr\Khayamm\Khayamm"
    output_file = r"C:\Users\Mina\Desktop\output.txt"

    # process steps
    print("🔹 Step 1: Renaming images...")
    rename_images_in_directory(rename_base_path)

    print("🔹 Step 2: Processing Excel and generating labels...")
    process_excel_and_save_labels(excel_file_path, khayamm_base_path, output_file)
